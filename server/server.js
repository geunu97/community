...
(() => {
  var e = {
            ...
            : (function (e) {
                ...
                switch (process.binding("tty_wrap").guessHandleType(e)) {
                  case "TTY":
                    ...
                    break;
                  case "FILE":
                    (t = new (n(7147).SyncWriteStream)(e, {
                      autoClose: !1,
                    }))._type = "fs";
                    break;
                  case "PIPE":
      ...
      6309: (e, t, n) => {
        ...
        e.exports = function (e, t, n, u, l, d) {
          ...
          if (
            ((v.length = f),
            (v.encoding = x ? null : h),
            null === v.encoding && null !== h && !o.encodingExists(h))
          )
            return n(
              a(415, 'unsupported charset "' + h.toUpperCase() + '"', {
          ...
          l("read body"),
            r(m, v, function (r, p) {
              ...
              if (r)
                return (
                  (d =
                    "encoding.unsupported" === r.type
                      ? a(
                          415,
                          'unsupported charset "' + h.toUpperCase() + '"',
                          {
                            charset: h.toLowerCase(),
                            type: "charset.unsupported",
                          }
              ...
              try {
                l("parse body"),
                  (f = "string" != typeof p && null !== h ? o.decode(p, h) : p),
                  (e.body = u(f));
              } catch (e) {
                return void n(
      ...
      1487: (e, t, n) => {
              ...
              if ("{" !== t && "[" !== t)
                throw (
                  ...
                  (function (e, t) {
                    ...
                    try {
                      throw (
                        (JSON.parse(a), new SyntaxError("strict violation"))
                      );
                    } catch (e) {
                      return u(e, {
        ...
        function u(e, t) {
          for (
            var n = Object.getOwnPropertyNames(e), a = 0;
            a < n.length;
            a++
          ) {
            var i = n[a];
      ...
      3676: (e, t, n) => {
        ...
        e.exports = function (e) {
          ...
          return function (e, t, n) {
            ...
            if ((o("content-type %j", e.headers["content-type"]), !x(e)))
      ...
      5758: (e) => {
        ...
        function r(e, i) {
          ...
          return (
            p || (l = l.replace(n, "$1")), o && (l = l.replace(t, o)), l + s + u
          );
        }
        function o(e) {
      ...
      3578: (e, t, n) => {
        ...
        e.exports = function (e) {
          ...
          var t = r.exec(e),
            n = t && t[1].toLowerCase(),
            o = a[n];
          return o && void 0 !== o.compressible
            ? o.compressible
            : i.test(n) || void 0;
        };
      },
              ...
              (r.flush = function () {
                ...
                (r.write = function (e, t) {
                  return (
                    ...
                    h ? h.write(m(e, t)) : w.call(this, e, t))
                  );
                }),
                (r.end = function (e, t) {
                  return (
                ...
                c(r, function () {
                  if (n(e, r))
                    if (
                      ...
                      if (
                        (p(r, "Accept-Encoding"),
                        Number(r.getHeader("Content-Length")) < o || v < o)
                      )
                        _("size below threshold");
                      else if (
                        "identity" ===
                        (r.getHeader("Content-Encoding") || "identity")
                      )
                        if ("HEAD" !== e.method) {
                          var i = a(e),
        ...
        (e.exports = function (e, t) {
          ...
          (e.exports.parse = function (e) {
            ...
            var n,
              ...
              s = {};
            for (
              i = l.lastIndex = ";" === t[0].substr(-1) ? i - 1 : i;
              (t = l.exec(e));
            ...
            if (-1 !== a) {
              ...
              for (n.lastIndex = a; (u = n.exec(t)); ) {
                ...
                (a += u[0].length),
                  (c = u[1].toLowerCase()),
                  '"' === (l = u[2])[0] &&
                    (l = l.substr(1, l.length - 2).replace(r, "$1")),
                  (o.parameters[c] = l);
              }
              if (a !== t.length)
                throw new TypeError("invalid parameter format");
            ...
            return (
              e.origin && "*" !== e.origin
                ? r(e.origin)
                  ...
                  : ((n = o(a, e.origin)),
                    i.push([
                      { key: "Access-Control-Allow-Origin", value: !!n && a },
                    ]),
                    i.push([{ key: "Vary", value: "Origin" }]))
          ...
          return (
            ...
            (n._ignored = (function (e) {
              return (
                ...
                r(process.env.NO_DEPRECATION || "", e)
              );
            })(e)),
            (n._namespace = e),
            (n._traced = (function (e) {
              return (
                ...
                r(process.env.TRACE_DEPRECATION || "", e)
              );
            })(e)),
          ...
          if (i || !this._ignored) {
            ...
            if (void 0 === b || !(b in this._warned)) {
              ...
              if ((y || (y = s !== d && s.name ? p(s) : p(d)), i)) {
                ...
                var _ = (process.stderr.isTTY ? l : u).call(
                  this,
                  y,
                  r,
                  h.slice(m)
          ...
          return (
            !(function (e) {
              ...
              ? (function (e) {
                  return (
                    e instanceof o.Gzip ||
                    e instanceof o.Gunzip ||
                    e instanceof o.Deflate ||
                    e instanceof o.DeflateRaw ||
                    e instanceof o.Inflate ||
                    e instanceof o.InflateRaw ||
                    e instanceof o.Unzip
                  );
                })(e)
                ? (function (e) {
                      ...
                      ? e._binding
                        ? (e.destroy(),
                          e._processing
                            ...
                            : e._binding.clear())
                        : e._destroy &&
                          e._destroy !== r.Transform.prototype._destroy
                        ? e.destroy()
        ...
        e.exports = function (e, n) {
          ...
          function l() {
            for (var e, t = 0; t < a.length; t++)
              (e = a[t]).ee.removeListener(e.event, e.fn);
          }
          function d(e) {
            n = e;
          }
            ...
            o =
              ...
              ("function" == typeof i && n instanceof i) ||
                (n &&
                  "object" == typeof n &&
                  "ctime" in n &&
                  "[object Date]" === r.call(n.ctime) &&
                  "mtime" in n &&
                  "[object Date]" === r.call(n.mtime) &&
                  "ino" in n &&
                  "number" == typeof n.ino &&
                  "size" in n &&
                  "number" == typeof n.size)),
            s = t && "boolean" == typeof t.weak ? t.weak : o;
          if (!o && "string" != typeof e && !Buffer.isBuffer(e))
            throw new TypeError(
        ...
        (w.init = function () {
          ...
          (w.defaultConfiguration = function () {
            ...
            this.enable("x-powered-by"),
              ...
              Object.defineProperty(this.settings, _, {
                configurable: !0,
                value: !0,
              }),
      ...
      1319: (e, t, n) => {
        ...
        (C.status = function (e) {
          ...
          (C.sendFile = function (e, t, n) {
            ...
            if (
              ("function" == typeof t && ((a = t), (o = {})), !o.root && !u(e))
            )
              throw new TypeError(
          ...
          (C.download = function (e, t, n, a) {
            ...
            if (s && s.headers)
              for (var p = Object.keys(s.headers), u = 0; u < p.length; u++) {
                var l = p[u];
                "content-disposition" !== l.toLowerCase() &&
                  (c[l] = s.headers[l]);
              }
          ...
          (v.handle = function (e, t, n) {
            ...
            function _(n) {
              ...
              if (
                ...
                0 !== l.length &&
                  ((e.baseUrl = y),
                  (e.url = p + l + e.url.slice(p.length)),
                  (l = "")),
                "router" !== i)
              )
                    ...
                    n
                      ...
                      : (function (n, a, i, r) {
                          ...
                          s("%s %s : %s", n.name, i, e.originalUrl),
                            a
                              ? n.handle_error(a, e, t, _)
                              : n.handle_request(e, t, _);
                        })(r, i, O, C),
                      (f = 0);
                  });
                }
            ...
            function m(e) {
              return e
                ...
                : ((f = 0),
                  ...
                  (l = t[s]),
                  void 0 !== p && u
                    ? l && (l.match === p || (l.error && "route" !== l.error))
                      ? ((n.params[s] = l.value), m(l.error))
                      : ((t[s] = l = { error: null, match: p, value: p }),
                        void v())
                    : m());
            }
            function v(e) {
              var t = u[f++];
              if (((l.value = n.params[c.name]), e))
                return (l.error = e), void m(e);
              if (!t) return m();
              try {
                t(n, a, v, p, c.name);
              } catch (e) {
      ...
      9532: (e, t, n) => {
        ...
        function l(e, t) {
          ...
          if (
            ...
            if ("function" != typeof s)
              throw new Error(
                'Module "' + o + '" does not provide a view engine.'
              );
          ...
          return (
            ...
            function (i, s, c) {
              ...
              (i.url = i.originalUrl =
                ...
                i.url.indexOf("?") > 0 &&
                  ((i.query = r.parse(i.url, !0).query),
                  a("rewrite updated new query", i.query)),
                t ? c() : c("route");
            }
          );
        };
      ...
      6930: (e, t, n) => {
              ...
              (function e(n, a, i, r) {
                return t(n, a, function (t) {
                  !t || ("EMFILE" !== t.code && "ENFILE" !== t.code)
                    ...
                    : v([e, [n, a, i], t, r || Date.now(), Date.now()]);
                });
              })(e, n, a)
            );
          };
              ...
              (function e(t, a, i, r, o) {
                return n(t, a, i, function (n) {
                  !n || ("EMFILE" !== n.code && "ENFILE" !== n.code)
                    ...
                    : v([e, [t, a, i, r], n, o || Date.now(), Date.now()]);
                });
              })(e, t, a, i)
            );
          };
                ...
                (function e(t, n, i, r, o) {
                  return a(t, n, i, function (a) {
                    !a || ("EMFILE" !== a.code && "ENFILE" !== a.code)
                      ? "function" == typeof r && r.apply(this, arguments)
                      : v([e, [t, n, i, r], a, o || Date.now(), Date.now()]);
                  });
                })(e, t, n, i)
              );
            });
                ...
                (function e(t, n, a, r, o) {
                  return i(t, n, a, function (i) {
                    !i || ("EMFILE" !== i.code && "ENFILE" !== i.code)
                      ? "function" == typeof r && r.apply(this, arguments)
                      : v([e, [t, n, a, r], i, o || Date.now(), Date.now()]);
                  });
                })(e, t, n, a)
              );
            });
            ...
            function i(e, t, n, i) {
              return function (r, o) {
                !r || ("EMFILE" !== r.code && "ENFILE" !== r.code)
                  ? (o && o.sort && o.sort(),
                    "function" == typeof n && n.call(this, r, o))
                  : v([a, [e, t, n], r, i || Date.now(), Date.now()]);
              };
            }
          };
          var c = /^v[0-5]\./;
              ...
              (function e(t, n, a, i, r) {
                return g(t, n, a, function (o, s) {
                  !o || ("EMFILE" !== o.code && "ENFILE" !== o.code)
                    ? "function" == typeof i && i.apply(this, arguments)
                    : v([e, [t, n, a, i], o, r || Date.now(), Date.now()]);
                });
              })(e, t, n, a)
            );
          }
        ...
        function h() {
          for (var e = Date.now(), t = 0; t < r[a].length; ++t)
            r[a][t].length > 2 && ((r[a][t][3] = e), (r[a][t][4] = e));
          x();
        }
        function x() {
          if ((clearTimeout(l), (l = void 0), 0 !== r[a].length)) {
            ...
            if (void 0 === o) d("RETRY", t.name, n), t.apply(null, n);
              ...
              var p = Date.now() - s,
                u = Math.max(s - o, 1);
              p >= Math.min(1.2 * u, 100)
                ? (d("RETRY", t.name, n), t.apply(null, n.concat([o])))
                : r[a].push(e);
            }
            void 0 === l && (l = setTimeout(x, 0));
          }
        }
        global[a] || u(global, r[a]),
          (e.exports = m(c(r))),
          process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH &&
            !r.__patched &&
            ((e.exports = m(r)), (r.__patched = !0));
      },
      9857: (e, t, n) => {
        var a = n(2781).Stream;
        e.exports = function (e) {
              ...
              (e.rename =
                "function" != typeof e.rename
                  ...
                  : (function (t) {
                      ...
                      return (
                        Object.setPrototypeOf && Object.setPrototypeOf(n, t), n
                      );
                    })(e.rename)),
            (e.read =
                ...
                : (function (t) {
                    function n(n, a, i, r, o, s) {
                      ...
                      if (s && "function" == typeof s) {
                        var p = 0;
                        c = function (u, l, d) {
                          if (u && "EAGAIN" === u.code && p < 10)
                            return p++, t.call(e, n, a, i, r, o, c);
      ...
      6205: (e, t, n) => {
        ...
        (e.exports = function e() {
          for (var t, n, a = 500, r = {}, s = 0; s < arguments.length; s++) {
            var c = arguments[s],
              u = typeof c;
            if ("object" === u && c instanceof Error)
              ...
              if ("object" !== u)
                throw new TypeError(
                  "argument #" + (s + 1) + " unsupported type " + u
                );
              r = c;
            }
          }
          "number" == typeof a &&
            ...
            ("number" != typeof a ||
              (!o.message[a] && (a < 400 || a >= 600))) &&
              (a = 500);
          var l = e[a] || e[p(a)];
          for (var d in (t ||
            ((t = l ? new l(n) : new Error(n || o.message[a])),
            Error.captureStackTrace(t, e)),
          (l && t instanceof l && t.status === a) ||
      ...
      8192: (e, t, n) => {
        ...
        t._dbcs = p;
        for (
          var i = -1, r = -10, o = -1e3, s = new Array(256), c = 0;
          c < 256;
          c++
        )
          s[c] = i;
        ...
        (p.prototype.encoder = u),
          ...
          (p.prototype._getDecodeTrieNode = function (e) {
            ...
            for (var n = this.decodeTables[0], a = t.length - 1; a > 0; a--) {
              var r = n[t[a]];
              if (r == i)
                (n[t[a]] = o - this.decodeTables.length),
              ...
              if ("string" == typeof i)
                for (var o = 0; o < i.length; ) {
                  ...
                  if (55296 <= s && s < 56320) {
                    ...
                    for (var p = 4095 - s + 2, u = [], l = 0; l < p; l++)
          ...
          (p.prototype._fillEncodeTable = function (e, t, n) {
            for (var a = this.decodeTables[e], i = 0; i < 256; i++) {
              ...
              n[c] ||
                (s >= 0
                  ? this._setEncodeChar(s, c)
                  : s <= o
                  ? this._fillEncodeTable(o - s, c << 8, n)
                  : s <= r &&
                    this._setEncodeSequence(this.decodeTableSeq[r - s], c));
            }
          }),
            ...
            for (
              ...
              if (void 0 !== o && u != i) {
                ...
                if (l == i && this.gb18030) {
                  ...
                  if (-1 != v) {
                    (l =
                      this.gb18030.gbChars[v] + (u - this.gb18030.uChars[v])),
              ...
              l === i && (l = this.defaultCharSingleByte),
                l < 256
                  ? (t[p++] = l)
                  : l < 65536
                  ? ((t[p++] = l >> 8), (t[p++] = 255 & l))
          ...
          (l.prototype.write = function (e) {
            ...
            for (var u = 0, l = 0; u < e.length; u++) {
              ...
              if ((f = this.decodeTables[n][m]) >= 0);
                ...
                (u = p), (f = this.defaultCharUnicode.charCodeAt(0));
              else if (-2 === f) {
                ...
                for (
                  var g = this.decodeTableSeq[r - f], b = 0;
                  b < g.length - 1;
                  b++
                )
                  (f = g[b]), (t[l++] = 255 & f), (t[l++] = f >> 8);
                f = g[g.length - 1];
              }
              if (f > 65535) {
                f -= 65536;
            ...
            return (
              (this.nodeIdx = n),
              (this.prevBuf = p >= 0 ? e.slice(p) : s.slice(p + c)),
      ...
      7717: (e, t, n) => {
        ...
        r.prototype.end || (r.prototype.end = function () {}),
          ...
          (p.prototype.write = function (e) {
            for (
              var t = a.alloc(3 * e.length), n = 0, i = 0;
              i < e.length;
              i++
            ) {
          ...
          if (e.length >= 2)
            if (254 == e[0] && 255 == e[1]) n = "utf-16be";
              ...
              for (
                var a = 0,
                  i = 0,
                  r = Math.min(e.length - (e.length % 2), 64),
                  o = 0;
                o < r;
                o += 2
              )
      ...
      1618: (e, t, n) => {
        ...
        (o.prototype.write = function (e) {
          ...
          (o.prototype.end = function () {});
        for (var c = /[A-Za-z0-9\/+]/, p = [], u = 0; u < 256; u++)
          p[u] = c.test(String.fromCharCode(u));
        var l = "+".charCodeAt(0),
          d = "-".charCodeAt(0),
          f = "&".charCodeAt(0);
        function m(e, t) {
        ...
        (s.prototype.write = function (e) {
          ...
          (v.prototype.write = function (e) {
            ...
            return (
              (this.inBase64 = t), (this.base64AccumIdx = i), r.slice(0, o)
            );
          }),
              ...
              if (!t) {
                ...
                if (
                  ...
                  (r.prototype.write = function (n, i, r, o) {
                    ...
                    var p = e.encode(n, o);
                    return (
                      p.length < r && (r = p.length), p.copy(this, i, 0, r), r
                    );
                  }),
                  ...
                  (a.prototype.write = function (n, i, r, o) {
                    ...
                    var d = e.encode(n, o);
                    return (
                      d.length < r && (r = d.length), d.copy(this, i, 0, r), r
                    );
                  }),
                  e.supportsStreams)
                ) {
        ...
        (r.encodings = null),
          ...
          (r.getEncoder = function (e, t) {
            var n = r.getCodec(e),
              a = new n.encoder(t, n);
            return (
              n.bomAware && t && t.addBOM && (a = new i.PrependBOM(a, t)), a
            );
          }),
              ...
              (n.IPv4.broadcastAddressFromCIDR = function (e) {
                ...
                try {
                  for (
                    ...
                    i.push(parseInt(a[n], 10) | (255 ^ parseInt(r[n], 10))),
                      n++;
                  return new this(i);
                } catch (e) {
                  throw new Error(
      ...
      4468: (e, t, n) => {
        ...
        const a = n(2081);
        e.exports = [
          a.json({ limit: "10mb", extended: !1 }),
          a.urlencoded({ extended: !1 }),
        ];
      },
      5171: (e, t, n) => {
        "use strict";
        ...
        e.exports = function (e) {
          const t = i.join(process.cwd(), "public"),
            ...
            l = [];
          return (
            (e = Object.assign({ logger: !0, static: u }, e)).noGzip ||
              l.push(c()),
            e.noCors || l.push(s({ origin: !0, credentials: !0 })),
            l.push(r.static(e.static)),
            e.logger &&
              l.push(o("dev", { skip: (e) => "/favicon.ico" === e.path })),
            l.push((e, t, n) => {
              t.header("Cache-Control", "no-cache"),
                t.header("Pragma", "no-cache"),
                t.header("Expires", "-1"),
                n();
            }),
            e.readOnly &&
                ...
                n.each(r, (r) => {
                  n.each(r, (s, c) => {
                    if (new RegExp(`${t.foreignKeySuffix}$`).test(c)) {
                      const p = i.plural(
                        c.replace(new RegExp(`${t.foreignKeySuffix}$`), "")
                      );
                      if (e[p]) {
      ...
      1603: (e, t, n) => {
        ...
        const a = n(4511);
        e.exports = function (e, t, n) {
          const i = isNaN(parseFloat(e.query._delay))
            ? 1
            : parseFloat(e.query._delay);
      ...
      3417: (e, t, n) => {
        ...
        const a = n(7310);
        e.exports = function (e) {
          return `${a.format({ protocol: e.protocol, host: e.get("host") })}${
            e.originalUrl
          }`;
        };
      },
      2801: (e, t, n) => {
        ...
        const a = n(7214),
          ...
          v = n(9232);
        e.exports = (e, t) => {
          (t = Object.assign({ foreignKeySuffix: "Id", _isFake: !1 }, t)),
            "string" == typeof e
              ? (e = s(new p(e)))
              : (r.has(e, "__chain__") && r.has(e, "__wrapped__")) ||
                (e = s(new c()).setState(e));
          const n = a.Router();
          return (
            n.use(i()),
            n.use(u),
            ...
            e
              .forEach((a, i) => {
                if (r.isPlainObject(a)) n.use(`/${i}`, m(e, i, t));
                  ...
                  if (!r.isArray(a))
                    throw new Error(
                      `Type of "${i}" (${typeof a})  is not supported. Use objects or arrays of objects.`
                    );
                  n.use(`/${i}`, d(e, i, t));
                }
              })
              .value(),
            n.use((e, t) => {
              t.locals.data || (t.status(404), (t.locals.data = {})),
                n.render(e, t);
            }),
            n.use((e, t, n, a) => {
          ...
          return (
            ...
            t
              .get("/:resource/:id/:nested", function (t, n, a) {
                ...
                (t.query[`${r}${e.foreignKeySuffix}`] = t.params.id),
                  (t.url = `/${t.params.nested}`),
                  a();
              })
              .post("/:resource/:id/:nested", function (t, n, a) {
                const r = i.singular(t.params.resource);
                (t.body[`${r}${e.foreignKeySuffix}`] = t.params.id),
                  (t.url = `/${t.params.nested}`),
                  a();
              })
          );
        ...
        e.exports = (e, t, n) => {
          ...
          function r(a, i) {
            i &&
              [].concat(i).forEach((i) => {
                if (e.get(i).value) {
                  const r = {};
                  (r[`${c.singular(t)}${n.foreignKeySuffix}`] = a.id),
                    (a[i] = e.get(i).filter(r).value());
                }
              });
          }
          function f(t, a) {
          ...
          function m(a, r, o) {
            ...
            if (n._isFake)
              ...
              (n =
                "PATCH" === a.method
                  ? n.updateById(s, a.body)
                  : n.replaceById(s, a.body)),
                (c = n.value());
            }
            c && (r.locals.data = c), o();
          }
          ...
          return (
            a
              ...
              .get(function (n, a, i) {
                          ...
                          .map(function (t) {
                            ...
                            if (null != o)
                              return i
                                ...
                                ? t !== o.toString()
                                : r
                                ? new RegExp(t, "i").test(o.toString())
                                : t === o.toString();
                          })
                ...
                if (
                  ((d || x || m) &&
                    (a.setHeader("X-Total-Count", o.size()),
                    a.setHeader(
                      "Access-Control-Expose-Headers",
                      "X-Total-Count" + (m ? ", Link" : "")
                    )),
                  m)
                ) {
                  (m = parseInt(m, 10)),
              ...
              .post(function (a, r, o) {
                ...
                r.setHeader("Access-Control-Expose-Headers", "Location"),
                  r.location(`${u(a)}/${s.id}`),
                  r.status(201),
                  (r.locals.data = s),
                  o();
        ...
        e.exports = (e, t, n) => {
          ...
          function r(a, r, o) {
            if (n._isFake)
              ...
              "PUT" === a.method
                ? e.set(t, a.body).value()
                : e.get(t).assign(a.body).value(),
                (r.locals.data = e.get(t).value());
            o();
          }
          a.use(p);
          const u = s(e);
          return (
            a
              ...
              .post(function (a, i, r) {
                n._isFake
                  ? (i.locals.data = a.body)
                  : (e.set(t, a.body).value(),
                    (i.locals.data = e.get(t).value())),
                  i.setHeader("Access-Control-Expose-Headers", "Location"),
                  i.location(`${c(a)}`),
                  i.status(201),
                  r();
              }, u)
      ...
      1231: (e, t, n) => {
        ...
        function i(e) {
          if (-1 !== e.indexOf("/")) {
            const t = [
              `Oops, found / character in database property '${e}'.`,
              "",
        ...
        e.exports = (e) => {
          if (!a.isPlainObject(e))
            throw new Error(
              `Data must be an object. Found ${typeof e}.See https://github.com/typicode/json-server for example.`
            );
        ...
        e.exports = {
          getPage: function (e, t, n) {
            ...
            return (
              ...
              0 === a.items.length ||
                (t > 1 && (a.prev = t - 1),
                r < e.length && (a.next = t + 1),
                a.items.length !== e.length &&
                  ((a.current = t),
                  (a.first = 1),
                  (a.last = Math.ceil(e.length / n)))),
              a
            );
          },
        };
        ...
        e.exports = {
          ...
          getById: function (e, t) {
            ...
            return this.find(e, function (e) {
              if (n.has(e, n.__id()))
                return e[n.__id()].toString() === t.toString();
            });
          },
          ...
          insert: function (e, t) {
            if (
              ((t[this.__id()] = t[this.__id()] || this.createId(e, t)),
              this.getById(e, t[this.__id()]))
            )
              ...
              vn = (function e(t) {
                var n,
                  a = (t =
                    null == t
                      ? lt
                      : vn.defaults(lt.Object(), t, vn.pick(lt, nt))).Array,
                  ie = t.Date,
                  we = t.Error,
                  _e = t.Function,
                  ke = t.Math,
                ...
                function ra(e, t) {
                  for (
                    var n = -1, r = t.length, o = a(r), s = null == e;
                    ++n < r;
                ...
                function Aa(e, t, n) {
                  var a =
                    null == (e = Cr(e, (t = xi(t, e)))) ? e : e[$r(Kr(t))];
                        ...
                        if ((r || (r = new Jn()), ts(o)))
                          !(function (e, t, n, a, r, o, s) {
                            ...
                            if (u) Xn(e, n, u);
                              ...
                              d && (s.set(p, l), r(l, p, a, o, s), s.delete(p)),
                                Xn(e, n, l);
                            }
                          })(e, t, s, n, Ra, a, r);
                        else {
                ...
                function Ha(e, t, n, a) {
                  var i = a ? Rt : Nt,
                    ...
                    s = e;
                  for (
                    e === t && (t = Ei(t)), n && (s = qt(e, Zt(n)));
                    ++r < o;

                  )
                    for (
                      var c = 0, p = t[r], u = n ? n(p) : p;
                      (c = i(s, u, c, a)) > -1;

                    )
                      s !== e && Ve.call(s, c, 1), Ve.call(e, c, 1);
                  return e;
                }
                function Wa(e, t) {
                ...
                function Ya(e, t, n, a) {
                  if (!ts(e)) return e;
                  for (
                    var r = -1, o = (t = xi(t, e)).length, s = o - 1, c = e;
                    null != c && ++r < o;
                ...
                function pi(e, t) {
                  return (
                    null == (e = Cr(e, (t = xi(t, e)))) || delete e[$r(Kr(t))]
                  );
                }
                function ui(e, t, n, a) {
                ...
                function fi(e, t, n) {
                  ...
                  for (var r = -1, o = a(i); ++r < i; )
                    for (var s = e[r], c = -1; ++c < i; )
                      c != r && (o[r] = ua(o[r] || s, e[c], t, n));
                  return ci(ha(o, 1), t, n);
                }
                function mi(e, t, n) {
                  for (
                    var a = -1, r = e.length, o = t.length, s = {};
                    ++a < r;
                ...
                function $i(e) {
                  return er(function (t) {
                    ...
                    return function () {
                      var e = arguments,
                        a = e[0];
                      if (c && 1 == e.length && Wo(a))
                        return c.plant(a).value();
                      for (
                        var i = 0, r = n ? t[i].apply(this, e) : a;
                        ++i < n;
                ...
                function Li(e, t, n, r, o, s, c, u, l, d) {
                  var f = t & p,
                    ...
                    g = v ? i : Pi(e);
                  return function i() {
                    for (var p = arguments.length, b = a(p), y = p; y--; )
                      b[y] = arguments[y];
                    if (h)
                      var w = rr(i),
                        _ = en(b, w);
                ...
                function Gi(e) {
                  ...
                  return function (e, n) {
                    if (
                      ((e = xs(e)),
                      (n = null == n ? 0 : gn(vs(n), 292)) && Bt(e))
                    ) {
                      var a = (bs(e) + "e").split("e");
                      return +(
                        (a = (bs(t(a[0] + "e" + (+a[1] + n))) + "e").split(
                          "e"
                        ))[0] +
                        "e" +
                        (+a[1] - n)
                        ...
                        ? (function (e, t, n) {
                            ...
                            return function o() {
                              ...
                              return (s -= l.length) < n
                                ...
                                : kt(
                                    this && this !== lt && this instanceof o
                                      ? r
                                      : e,
                                    this,
                                    c
                ...
                function Yi(e, t, n, a, r, o) {
                  return (
                    ts(e) &&
                      ts(t) &&
                      (o.set(t, e), Ra(e, t, i, Yi, o), o.delete(t)),
                    e
                  );
                }
                function Qi(e) {
                ...
                function Xi(e, t, n, a, r, o) {
                  ...
                  for (o.set(e, t), o.set(t, e); ++d < c; ) {
                    var v = e[d],
                      h = t[d];
                    if (a)
                      var x = s ? a(h, v, d, t, e, o) : a(v, h, d, e, t, o);
                    if (x !== i) {
                      if (x) continue;
                      f = !1;
                      break;
                ...
                function mr(e) {
                  return "function" != typeof e.constructor || wr(e)
                    ? {}
                    : Rn(He(e));
                }
                function vr(e) {
                ...
                ((kn && dr(new kn(new ArrayBuffer(1))) != F) ||
                  (jn && dr(new jn()) != _) ||
                  (Cn && dr(Cn.resolve()) != C) ||
                  (Sn && dr(new Sn()) != E) ||
                  (En && dr(new En()) != T)) &&
                ...
                function Sr(e, t) {
                  for (
                    var n = e.length, a = gn(t.length, n), r = Ei(e);
                    a--;
                ...
                function Nr(e) {
                  ...
                  return (
                    (t.__actions__ = Ei(e.__actions__)),
                ...
                function Hr(e, t, n) {
                  ...
                  return (
                    n !== i &&
                      ((r = vs(n)), (r = n < 0 ? xn(a + r, 0) : gn(r, a - 1))),
                    Lt(e, or(t, 3), r, !0)
                  );
                }
                function Wr(e) {
                ...
                var oo = Ja(function (e, t) {
                  ...
                  po = Ja(function (e) {
                    var t = Kr(e);
                    return (
                      (t = "function" == typeof t ? t : i), fi(Ot(e, Jo), i, t)
                    );
                  }),
                  uo = Ja(io),
                  lo = Ja(function (e) {
                    var t = e.length,
                      n = t > 1 ? e[t - 1] : i;
                    return (
                      (n = "function" == typeof n ? (e.pop(), n) : i), ro(e, n)
                    );
                  });
                function fo(e) {
                  var t = Nn(e);
                ...
                var $o = gi(function (e, t) {
                    var n = (t =
                      1 == t.length && Wo(t[0])
                        ? qt(t[0], Zt(or()))
                        : qt(ha(t, 1), Zt(or()))).length;
                    return Ja(function (a) {
                      for (var i = -1, r = gn(a.length, n); ++i < r; )
                ...
                var Do = Hi(Ca),
                  ...
                  Ho = Ta(
                    ...
                    : function (e) {
                        return (
                          ns(e) && ze.call(e, "callee") && !Ge.call(e, "callee")
                        );
                      },
                  Wo = a.isArray,
                  Go = xt
                ...
                function rs(e) {
                  ...
                  return (
                    "function" == typeof n && n instanceof n && Fe.call(n) == $e
                  );
                }
                var os = yt
                    ? Zt(yt)
                ...
                function cs(e) {
                  return (
                    "string" == typeof e || (!Wo(e) && ns(e) && ja(e) == O)
                  );
                }
                function ps(e) {
                ...
                var ys = Ti(function (e, t) {
                  ...
                  Cs = Ja(function (e, t) {
                    ...
                    for (r && xr(t[0], t[1], r) && (a = 1); ++n < a; )
                      for (
                        var o = t[n], s = zs(o), c = -1, p = s.length;
                        ++c < p;

                      ) {
                        var u = s[c],
                          l = e[u];
                        (l === i || (Uo(l, Te[u]) && !ze.call(e, u))) &&
                          (e[u] = o[u]);
                      }
                    return e;
                  }),
                ...
                function cc(e, t, n) {
                  var a = Fs(t),
                    i = wa(t, a);
                  null != n ||
                    (ts(t) && (i.length || !a.length)) ||
                    ((n = t), (t = e), (e = this), (i = wa(t, Fs(t))));
                ...
                return (
                  ...
                  (Nn.chunk = function (e, t, n) {
                    ...
                    if (!r || t < 1) return [];
                    for (var o = 0, s = 0, c = a(dt(r / t)); o < r; )
                      c[s++] = ti(e, o, (o += t));
                    return c;
                  }),
                  ...
                  (Nn.concat = function () {
                    ...
                    if (!e) return [];
                    for (var t = a(e - 1), n = arguments[0], i = e; i--; )
                      t[i - 1] = arguments[i];
                  ...
                  (Nn.split = function (e, t, n) {
                    return (
                      n && "number" != typeof n && xr(e, t, n) && (t = n = i),
                      (n = n === i ? f : n >>> 0)
                        ? (e = bs(e)) &&
                  ...
                  (Nn.throttle = function (e, t, n) {
                    ...
                    return (
                      ...
                      Fo(e, t, { leading: a, maxWait: t, trailing: i })
                    );
                  }),
                  (Nn.thru = mo),
                  (Nn.toArray = fs),
                  ...
                  (Nn.isMatchWith = function (e, t, n) {
                    return (
                      (n = "function" == typeof n ? n : i), Fa(e, t, cr(t), n)
                    );
                  }),
                  (Nn.isNaN = function (e) {
                    return is(e) && e != +e;
                  ...
                  (Nn.truncate = function (e, t) {
                    ...
                    if (ts(t)) {
                      ...
                      (n = "length" in t ? vs(t.length) : n),
                        (a = "omission" in t ? si(t.omission) : a);
                    }
                    var o = (e = bs(e)).length;
                    if (rn(e)) {
                      var s = dn(e);
                    ...
                    if ((s && (c += p.length - c), os(r))) {
                      if (e.slice(c).search(r)) {
                        var u,
                          l = p;
                        for (
                          r.global || (r = Ce(r.source, bs(de.exec(r)) + "g")),
                            r.lastIndex = 0;
                          (u = r.exec(l));
                  ...
                  Ct(["drop", "take"], function (e, t) {
                    (Mn.prototype[e] = function (n) {
                      ...
                      return (
                        a.__filtered__
                          ? (a.__takeCount__ = gn(n, a.__takeCount__))
                          : a.__views__.push({
                              size: gn(n, f),
                  ...
                  Ct(["filter", "map", "takeWhile"], function (e, t) {
                    ...
                    Mn.prototype[e] = function (e) {
                      var t = this.clone();
                      return (
                        t.__iteratees__.push({ iteratee: or(e, 3), type: n }),
                  ...
                  (Mn.prototype.slice = function (e, t) {
                    ...
                    return n.__filtered__ && (e > 0 || t < 0)
                      ...
                      : (e < 0 ? (n = n.takeRight(-e)) : e && (n = n.drop(e)),
                        t !== i &&
                          (n =
                            (t = vs(t)) < 0 ? n.dropRight(-t) : n.take(t - e)),
                        n);
                  }),
                  ...
                  (Mn.prototype.clone = function () {
                    ...
                    return (
                      (e.__actions__ = Ei(this.__actions__)),
                      (e.__dir__ = this.__dir__),
                      (e.__filtered__ = this.__filtered__),
                      (e.__iteratees__ = Ei(this.__iteratees__)),
                      (e.__takeCount__ = this.__takeCount__),
                      (e.__views__ = Ei(this.__views__)),
                      e
                    );
                  }),
              ...
              a(t, [
                {
                  key: "read",
                  value: function () {
                    if (!o.existsSync(this.source))
                      return (
                        p(this.source, this.serialize(this.defaultValue)),
                        this.defaultValue
                      );
                    try {
        ...
        e.exports = function (e, t) {
          var n,
            ...
            u =
              "function" == typeof e
                ? e
                : "X-" ===
                  (n = e || "X-HTTP-Method-Override").substr(0, 2).toUpperCase()
                ? (function (e) {
                    var t = e.toLowerCase();
                    return function (n, a) {
                      s(a, e);
          ...
          return function (e, t, n) {
            ...
            if (
              ...
              l && -1 === l.indexOf(e.originalMethod))
            )
              return n();
            (r = u(e, t)),
              void 0 !== (i = Array.isArray(r) ? r[0] : r) &&
                c(i) &&
                ((e.method = i.toUpperCase()),
                a("override %s as %s", e.originalMethod, e.method)),
              n();
          };
        };
      },
              ...
              for (var s = 0; s < n.length; s++) {
                ...
                if (i[c]) {
                  ...
                  if (
                    ...
                    (p > u ||
                      (p === u && "application/" === i[c].substr(0, 12)))
                  )
                    continue;
                }
                i[c] = e;
      ...
      1453: (e, t, n) => {
        ...
        function p(e, t) {
          ...
          e &&
            "object" == typeof e &&
            ((n = (a = e).format || "default"),
            r(
              "morgan(options): use morgan(" +
                ("string" == typeof n ? JSON.stringify(n) : "format") +
                ", options) instead"
            )),
            void 0 === n && r("undefined format: specify a format");
          var c = a.immediate,
            d = a.skip || !1,
            f =
              "function" != typeof n
            ...
            function (e, t, n) {
              function a() {
                if (!1 !== d && d(e, t)) i("skip request");
                  ...
                  var n = f(p, e, t);
                  null != n
                    ? (i("log request"), h.write(n + "\n"))
                    : i("skip line");
                }
              }
              (e._startAt = void 0),
                (e._startTime = void 0),
                (e._remoteAddress = l(e)),
                (t._startAt = void 0),
                (t._startTime = void 0),
                m.call(e),
                c ? a() : (s(t, m), o(t, a)),
        ...
        function u(e) {
          ...
          var t =
            '  "use strict"\n  return ' +
            String(JSON.stringify(e)).replace(
              /:([-\w]{2,})(?:\[([^\]]+)\])?/g,
              function (e, t, n) {
                var a = "req, res",
                  i = "tokens[" + String(JSON.stringify(t)) + "]";
                return (
                  void 0 !== n && (a += ", " + String(JSON.stringify(n))),
                  '" +\n    (' + i + "(" + a + ') || "-") + "'
                );
              }
            );
        ...
        function l(e) {
          return (
            e.ip ||
            e._remoteAddress ||
            (e.connection && e.connection.remoteAddress) ||
            void 0
          );
        }
        function d(e) {
        ...
        p.format(
              ...
              o ||
                (o = e[r] =
                  u(
                    "[0m:method :url [" +
                      r +
                      "m:status[0m :response-time ms - :res[content-length][0m"
                  )),
              o(t, n, a)
            );
          }),
          ...
          p.token("response-time", function (e, t, n) {
            if (e._startAt && t._startAt)
              return (
                1e3 * (t._startAt[0] - e._startAt[0]) +
                1e-6 * (t._startAt[1] - e._startAt[1])
              ).toFixed(void 0 === n ? 3 : n);
          }),
      ...
      2825: (e) => {
        ...
        function i(e, t) {
          var i = (function (e) {
            ...
            return (
              i || (t[s++] = { encoding: "identity", q: r, i: o }),
              (t.length = s),
              t
            );
          })(e || "");
            ...
            for (
              var u = (function (e) {
                  for (var t = e.split(";"), n = 1, a = 0; n < t.length; n++)
                    c(t[a]) % 2 == 0 ? (t[++a] = t[n]) : (t[a] += ";" + t[n]);
                  for (t.length = a + 1, n = 0; n < t.length; n++)
                    t[n] = t[n].trim();
                  return t;
                })(a[3]).map(p),
                l = 0;
      ...
      1411: (e, t, n) => {
        ...
        e.exports = function e(t, n, a, i) {
          ...
          if (
            (void 0 === a && (a = 0), a >= S && S > 0 && "object" == typeof t)
          )
          ...
          function M(t, n, r) {
            if ((n && (i = C.call(i)).push(n), r)) {
              var o = { depth: s.depth };
              return (
                H(s, "quoteStyle") && (o.quoteStyle = s.quoteStyle),
                e(t, o, a + 1, i)
              );
            }
            return e(t, s, a + 1, i);
          ...
          if (
            (O = t) &&
            "object" == typeof O &&
            (("undefined" != typeof HTMLElement && O instanceof HTMLElement) ||
            ...
            for (
              ...
              ne += " " + ae[ie].name + "=" + L(N(ae[ie].value), "double", s);
            return (
              (ne += ">"),
          ...
          if (
            ...
            return "cause" in Error.prototype ||
              ...
              : "{ [" +
                  String(t) +
                  "] " +
                  j.call(k.call("[cause]: " + M(t.cause), oe), ", ") +
                  " }";
          }
          if ("object" == typeof t && c) {
            if ($ && "function" == typeof t[$] && P)
              return P(t, { depth: S - a });
        ...
        function V(e, t) {
          ...
          return L(
            b.call(b.call(e, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, J),
            "single",
            t
          );
        }
          ...
          for (var c in e)
            H(e, c) &&
              ((n && String(Number(c)) === c && c < e.length) ||
                (T && r["$" + c] instanceof Symbol) ||
                (_.call(/[^\w$]/, c)
                  ? a.push(t(c, e) + ": " + t(e[c], e))
                  : a.push(c + ": " + t(e[c], e))));
          if ("function" == typeof O)
            for (var p = 0; p < o.length; p++)
              F.call(e, o[p]) && a.push("[" + t(o[p]) + "]: " + t(e[o[p]], e));
          return a;
        }
      },
      1278: (e, t, n) => {
        ...
        (e.exports = function (e, t) {
          return !1 !== o(e)
            ...
            : ((function (e, t) {
                ...
                ((n = t),
                a.AsyncResource &&
                  (s = new a.AsyncResource(n.name || "bound-anonymous-fn")),
      ...
      5478: (e) => {
        ...
        function a(e) {
          ...
          (this.statusCode = e),
            Array.isArray(r) ? t(this, r) : r && n(this, r);
          for (var o = new Array(Math.min(a, i)), s = 0; s < o.length; s++)
            o[s] = arguments[s];
          return o;
        }
        e.exports = function (e, t) {
            ...
            return function (i) {
              ...
              return (
                n ||
                  ...
                  "number" == typeof r[0] &&
                    this.statusCode !== r[0] &&
                    ((r[0] = this.statusCode), (r.length = 1))),
                e.apply(this, r)
              );
            };
          })(e.writeHead, t);
      ...
      5492: (e) => {
        e.exports = function e(n, a, i) {
          ...
          if (n instanceof RegExp) {
            for (; (r = t.exec(n.source)); )
              a.push({ name: d++, optional: !1, offset: r.index });
            return n;
          }
          if (Array.isArray(n))
            return (
          ...
          for (
            n = ("^" + n + (o ? "" : "/" === n[n.length - 1] ? "?" : "/?"))
              ...
              .replace(/\*/g, function (e, t) {
                for (var n = a.length; n-- > u && a[n].offset > t; )
                  a[n].offset += 3;
                return "(.*)";
              });
            (r = t.exec(n));
            ...
            f % 2 != 1 &&
              ((u + l === a.length || a[u + l].offset > r.index) &&
                a.splice(u + l, 0, {
                  name: d++,
                  optional: !1,
                  offset: r.index,
      ...
      4071: (e, t, n) => {
        ...
        function r(e, t) {
          for (
            var n, a = [], r = 0, o = 0, s = "", u = (t && t.delimiter) || "/";
            null != (n = i.exec(e));
        ...
        function s(e, t) {
          ...
          return function (t, i) {
            for (
              var r = "",
                s = t || {},
                c = (i || {}).pretty ? o : encodeURIComponent,
                p = 0;
              p < e.length;
              p++
            ) {
        ...
        function d(e, t, n) {
          a(t) || ((n = t || n), (t = []));
          for (
            var i = (n = n || {}).strict, r = !1 !== n.end, o = "", s = 0;
            s < e.length;
            s++
          ) {
            var p = e[s];
          ...
          return (
            i || (o = (v ? o.slice(0, -m.length) : o) + "(?:" + m + "(?=$))?"),
            (o += r ? "$" : i && v ? "" : "(?=" + m + "|$)"),
            u(new RegExp("^" + o, l(n)), t)
          );
        }
      },
      7071: function (e) {
        ...
        var a = n(136),
          ...
          p = function (e, t, n, a) {
            if (e) {
              ...
              for (
                var l = 0;
                n.depth > 0 && null !== (s = o.exec(r)) && l < n.depth;
          ...
          h = function e(t, n, r, o, s, u, d, f, h, x, g, b, y, w, _, k) {
            ...
            if (
              ...
              if (d) {
                ...
                if ("comma" === r && w) {
                  for (
                    var q = p.call(String(C), ","), F = "", z = 0;
                    z < q.length;
                    ++z
                  )
                    F +=
                      (0 === z ? "" : ",") +
                      y(d(q[z], m.encoder, _, "value", b));
                  return [
                    y(T) + (o && c(C) && 1 === q.length ? "[]" : "") + "=" + F,
                  ];
                }
            ...
            if ("comma" === r && c(C))
              I = [{ value: C.length > 0 ? C.join(",") || null : void 0 }];
            else if (c(f)) I = f;
            else {
              var B = Object.keys(C);
              I = h ? B.sort(h) : B;
            ...
            for (
              ...
              if (!u || null !== R) {
                ...
                var D = a();
                D.set(v, k),
                  l(P, e(R, U, r, o, s, u, d, f, h, x, g, b, y, w, _, D));
              }
            }
            return P;
          };
                  ...
                  (i = e.filter),
                {
                  addQueryPrefix:
                    "boolean" == typeof e.addQueryPrefix
                      ...
                      : m.addQueryPrefix,
                  allowDots:
                    void 0 === e.allowDots ? m.allowDots : !!e.allowDots,
                  charset: t,
                  charsetSentinel:
                    "boolean" == typeof e.charsetSentinel
                      ? e.charsetSentinel
        ...
        e.exports = {
          ...
          compact: function (e) {
            for (
              ...
              for (
                var i = t[a], o = i.obj[i.prop], s = Object.keys(o), c = 0;
                c < s.length;
                ++c
              ) {
                var p = s[c],
            ...
            return (
              ...
              r(t) && r(n)
                ...
                : Object.keys(n).reduce(function (t, r) {
                    var o = n[r];
                    return (
                      i.call(t, r) ? (t[r] = e(t[r], o, a)) : (t[r] = o), t
                    );
                  }, o)
            );
          },
      ...
      5285: (e, t, n) => {
        ...
        e.exports = function (e, t, n) {
          var r = n,
            o = t || {};
          if (
            ((!0 !== t && "string" != typeof t) || (o = { encoding: t }),
            "function" == typeof t && ((r = t), (o = {})),
          ...
          return r
            ? u(
                ...
                ((s = r),
                a.AsyncResource &&
                  (c = new a.AsyncResource(s.name || "bound-anonymous-fn")),
        ...
        function u(e, t, n, a, i) {
          ...
          if (e._decoder || (u && (u.encoding || u.decoder)))
            return m(
              r(500, "stream encoding should not be set", {
                type: "stream.encoding.set",
              })
            );
          if (void 0 !== e.readable && !e.readable)
            return m(
              r(500, "stream is not readable", { type: "stream.not.readable" })
            );
          var l,
            d = 0;
          try {
            l = (function (e) {
              ...
              try {
                ...
                throw r(415, "specified encoding unsupported", {
                  encoding: e,
                  type: "encoding.unsupported",
                });
              }
          ...
          function x(e) {
            if (!s) {
              ...
              null !== n && d !== n
                ? m(
                    r(400, "request size did not match content length", {
                      expected: n,
                      length: n,
                      received: d,
                ...
                : m(null, l ? f + (l.end() || "") : Buffer.concat(f));
            }
          }
          function g() {
            (f = null),
      ...
      4355: (e, t, n) => {
        ...
        function O(e, t, n) {
          ...
          (this._hidden = Boolean(a.hidden)),
            ...
            (this._extensions =
              void 0 !== a.extensions
                ? F(a.extensions, "extensions option")
                : []),
            (this._immutable = void 0 !== a.immutable && Boolean(a.immutable)),
            (this._index =
              void 0 !== a.index ? F(a.index, "index option") : ["index.html"]),
            (this._lastModified =
        ...
        (e.exports = function (e, t, n) {
          ...
          (O.prototype.from = r.function(
            O.prototype.root,
            "send.from: pass root as option"
          )),
          (O.prototype.root = r.function(
            O.prototype.root,
              ...
              if (this._acceptRanges && C.test(c)) {
                if (
                  ...
                  return (
                    ...
                    o.setHeader("Content-Range", A("bytes", n)),
                    this.error(416, {
                      headers: {
                ...
                -2 !== c &&
                  ...
                  (i("range %j", c),
                  (o.statusCode = 206),
                  o.setHeader("Content-Range", A("bytes", n, c[0])),
                  (p += c[0].start),
              ...
              i('stat "%s"', o),
                l.stat(o, function (e, t) {
                  return e
                    ...
                    : t.isDirectory()
                    ? a()
                    : (n.emit("file", o, t), void n.send(o, t));
                });
            }
            i('stat "%s"', e),
              l.stat(e, function (t, i) {
                return t &&
                  ...
                  : i.isDirectory()
                  ? n.redirect(e)
                  : (n.emit("file", e, i), void n.send(e, i));
              });
          }),
      ...
      1024: (e, t, n) => {
        ...
        var a = n(708);
        function i(e) {
          if (!Object.prototype.hasOwnProperty.call(r.message, e))
        ...
        function r(e) {
          ...
          return isNaN(t)
            ? (function (e) {
                var t = e.toLowerCase();
                if (!Object.prototype.hasOwnProperty.call(r.code, t))
          ...
          if ("function" != typeof e.unpipe) {
            if (
              ...
              for (var t, n = e.listeners("close"), a = 0; a < n.length; a++)
                ("cleanup" !== (t = n[a]).name && "onclose" !== t.name) ||
                  t.call(e);
          } else e.unpipe();
        };
      },
      ...
      8418: (e) => {
        ...
        function n(e, n) {
          ...
          for (
            var i = Array.isArray(n) ? n : a(String(n)), r = 0;
            r < i.length;
            r++
          )
            if (!t.test(i[r]))
      ...
      1787: (e, t, n) => {
        let a,
          ...
          s = (e) => {
            !a || a.length < e
              ? ((a = Buffer.allocUnsafe(128 * e)),
                r.randomFillSync(a),
                (i = 0))
              : i + e > a.length && (r.randomFillSync(a), (i = 0)),
              (i += e);
          },
            ...
            return (r = t) => {
              ...
              for (;;) {
                let t = n(i),
                  s = i;
                for (; s--; )
                  if (((o += e[t[s] & a] || ""), o.length === r)) return o;
              }
            };
          };
        e.exports = {
  ...
  (n.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t)),
    ...
    (() => {
      const e = n(2761),
        ...
        a = e.router("db.json"),
        i = (e) => (t, n, a) => {
          if (!["PATCH", "DELETE"].includes(t.method) || !t.path.includes(e))
            return a();
          fetch(`http://${t.hostname}:3000${t.path}?_password=true`)
            ...
            .then((e) =>
              e.password !== t.body.password
                ? n.status(401).send("Password is incorrect")
                : a()
            )
      ...
      (a.render = (e, t) =>
        e.query._password
          ? t.jsonp(t.locals.data)
          : t.locals.data instanceof Array
          ? t.jsonp(t.locals.data.map((e) => (delete e.password, e)))
          : t.jsonp({ ...t.locals.data, password: void 0 })),
        ...
        t.use(
          (e, t, n) => (
            "PUT" === e.method
              ? t.sendStatus(405)
              : "POST" === e.method
              ? (e.body.created_at = new Date().toISOString())
              : "PATCH" === e.method &&
                (e.body.updated_at = new Date().toISOString()),
            n()
          )
        ),
        t.use(a),
        ...
        t.listen(3e3, () =>
          console.log("Neo DaeRANG Machine Mk-VII is running at port 3000")
        );
    })();
})();
